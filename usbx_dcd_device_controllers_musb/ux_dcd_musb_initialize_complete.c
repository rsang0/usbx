...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _ux_dcd_musb_initialize_complete                  PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function completes the initialization of the MUSB USB        */
/*    device controller.                                                  */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
{
//printf("_ux_dcd_musb_initialize_complete\r\n");
UX_SLAVE_DCD            *dcd;
...
usb_status_t status;
    ...
    epCallback.callbackFn    = _ux_dcd_musb_control_callback;
    ...
    if (kStatus_USB_Success != status)
    {
        (void)USB_DeviceDeinitEndpoint(
                dcd_musb -> handle, USB_CONTROL_ENDPOINT | (USB_IN << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT));
        return status;
    }
